...
| `IAM_SERVICE_URI`      | `http://localhost:8082`                       | IAM service base URI (for routing)                                            |
| `IQKV_IAM_SERVICE_URL` | `http://localhost:8083`                       | IAM service URL for platform mode guard check                                 |
